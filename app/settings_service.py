...
DEFAULTS = {
"openai_model":"gpt-4.1-mini","openai_temperature":"0.2","openai_max_turns":"20","agent_system_prompt":"You are a polite Nomos clearing voice agent. Use very short spoken replies, maximum 1-2 sentences. Do not ask multiple questions at once. For first response, only ask for confirmation of the case.","extraction_prompt":"Extract structured clearing outcome JSON.",
